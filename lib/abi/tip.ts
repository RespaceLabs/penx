...
export const tipAbi = [
  {
    ...
    inputs: [
      ...
      { name: '_tree', internalType: 'contract TreeToken', type: 'address' },
    ],
    stateMutability: 'nonpayable',
  },
  {
