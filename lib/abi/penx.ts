...
export const spaceAbi = [
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Share.Contributor',
        type: 'tuple',
        components: [
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'tokenAmountAfterFee', internalType: 'uint256', type: 'uint256' },
  ...
  },
  {
    ...
    outputs: [
      {
        name: '',
        internalType: 'struct Member.Info',
        type: 'tuple',
        components: [
          {
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'consumed', internalType: 'uint256', type: 'uint256' },
        ],
      },
    ],
    stateMutability: 'view',
