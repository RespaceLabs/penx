...
CREATE TABLE "PersonalToken" (
    ...
    UNIQUE INDEX "PersonalToken_value_key"("value"),
    PRIMARY KEY ("id")
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE "SyncServer" (
    ...
    UNIQUE INDEX "SyncServer_token_key"("token"),
    INDEX "SyncServer_userId_idx"("userId"),
    PRIMARY KEY ("id")
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE "SiteSpace" (
    ...
    UNIQUE INDEX "SiteSpace_subdomain_key"("subdomain"),
    UNIQUE INDEX "SiteSpace_customDomain_key"("customDomain"),
    INDEX "SiteSpace_userId_idx"("userId"),
    PRIMARY KEY ("id")
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE "SiteNode" (
    ...
    INDEX "SiteNode_siteSpaceId_idx"("siteSpaceId"),
    INDEX "SiteNode_type_idx"("type"),
    PRIMARY KEY ("id")
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE "PublishedNode" (
    ...
    UNIQUE INDEX "PublishedNode_nodeId_key"("nodeId"),
    INDEX "PublishedNode_spaceId_idx"("spaceId"),
    INDEX "PublishedNode_nodeId_idx"("nodeId"),
    UNIQUE INDEX "PublishedNode_spaceId_nodeId_key"("spaceId", "nodeId"),
    PRIMARY KEY ("id")
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE "Post" (
    ...
    INDEX "Post_spaceId_idx"("spaceId"),
    INDEX "Post_nodeId_idx"("nodeId"),
    PRIMARY KEY ("id")
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
